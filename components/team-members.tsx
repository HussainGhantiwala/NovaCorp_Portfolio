    ...
    >
      {team.map((member, index) => (
        <motion.div key={index} variants={itemVariants}>
          <div
            className={`relative h-[400px] cursor-pointer rounded-lg border border-border/50 bg-card/30 shadow-sm transition-all duration-500 ${
              flippedCard === index ? "shadow-lg shadow-primary/20" : ""
            }`}
          ...
          >
            <div
              ...
              style={{
                ...
                pointerEvents: flippedCard === index ? "none" : "auto",
              }}
            >
